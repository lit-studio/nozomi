                    ...
                    <div class="item">
                        ...
                        <div class="c-footer-logo">
                            <a class="c-footer-logo-item" href="<?php echo home_url('/'); ?>" title="" rel="home">
                                <img class="logo" title='Nozomi Health'
                                     src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-footer-v.svg"
                                     alt=""/>
                            </a>
                        </div>
                        ...
                        <a class="c-footer-social-link dribble" href="<?php echo $dribbble_link; ?>" target="_blank">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path d="M22 12C22.0017 13.3172 21.7423 14.6216 21.237 15.8379C20.7316 17.0543 19.9901 18.1584 19.0555 19.0865C18.1285 20.0118 17.0283 20.7454 15.8177 21.2454C14.6071 21.7453 13.3098 22.0017 12 22C6.47701 22 2.00001 17.523 2.00001 12C1.99651 9.43589 2.98144 6.96909 4.75001 5.11251C5.68318 4.12781 6.80747 3.34388 8.05407 2.8087C9.30068 2.27352 10.6434 1.99834 12 2.00001C13.3098 1.99831 14.6071 2.25475 15.8177 2.75466C17.0283 3.25458 18.1285 3.98817 19.0555 4.91351C19.9901 5.84162 20.7316 6.94575 21.237 8.16208C21.7423 9.37842 22.0017 10.6829 22 12Z"
                                      fill="#2E2E2E" stroke="#9C9B98" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M22.0001 12.0003C20.5411 12.0003 16.5161 11.4503 12.9136 13.0318C9.00014 14.7503 6.16664 17.4158 4.93164 19.0738"
                                      stroke="#9C9B98" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M8.25 2.72754C9.815 4.17204 13.23 7.85004 14.5 11.5005C15.77 15.1515 16.24 19.6405 16.53 20.918"
                                      stroke="#9C9B98" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M2.07715 10.7499C3.96615 10.8639 8.96665 10.9664 12.1666 9.59986C15.3666 8.23336 18.1201 5.71986 19.0646 4.92236"
                                      stroke="#9C9B98" stroke-width="1.5" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                            </svg>
                        </a>
