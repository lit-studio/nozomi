                        ...
                        <div class="item">
                            <div class="item-title">
                                <div class="item-title--title">
                                    We believe in our “design + engineering magic” initially created by Steve Jobs
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="item">
                            ...
                            <div class="item-content">
                                <div class="item-desc c-article-content">
                                    ...
                                    <p>
                                        <strong>
                                            That’s why we are only working with a products where we can cover both sides.
                                        </strong>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="work-top">
                            ...
                            <div class="work-title">
                                <div class="work-title--title">
                                    Quick highlights you should know about our process
                                </div>
                            </div>
                        </div>
                        <div class="work-content">
                            <div class="work-row">
                                <div class="work-col work-img">
                                    <div class="item">
                                        <div class="item-img">
                                            <img class="img"  src="<?php echo get_template_directory_uri() ?>/assets/images/how/how-img.jpg">
                                        </div>
                                    </div>
                                </div>
