                                                    ...
                                                    <div class="item-content">
                                                        ...
                                                        <div class="item-bottom">
                                                            ...
                                                            <div class="item-socials">
                                                                ...
                                                                <?php
                                                                $photo_who_we_are_telegram = get_sub_field('telegram');
                                                                if ($photo_who_we_are_telegram) { ?>
                                                                    <a target='_blank' class="item-socials-social telegram" href="https://telegram.me/<?php echo $photo_who_we_are_telegram; ?>">
                                                                ...
                                                                <?php } ?>
                                                                <?php
                                                                $photo_who_we_are_instagram = get_sub_field('instagram');
                                                                if ($photo_who_we_are_instagram) { ?>
                                                                    <a target='_blank' class="item-socials-social instagram" href="<?php echo $photo_who_we_are_instagram; ?>">
                                                                        <svg width="100%" height="100%" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
