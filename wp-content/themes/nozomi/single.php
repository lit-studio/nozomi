                                ...
                                <div class="blog-top-share">
                                    ...
                                    <ul class="blog-top-share-list">
                                        <li class="blog-top-share-li">
                                            <a class="blog-top-share-link facebook" href="#">
                                                <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="url(#clip0_3501_8499)">
                                                    <path d="M0 12C0 5.37258 5.37258 0 12 0C18.6274 0 24 5.37258 24 12C24 18.6274 18.6274 24 12 24C5.37258 24 0 18.6274 0 12Z" fill="#E3DCD1"/>
                                                    <path d="M14.397 23.997V15.801H17.162L17.573 12.592H14.397V10.548C14.397 9.62199 14.655 8.98799 15.984 8.98799H17.668V6.12699C16.8486 6.03918 16.025 5.99678 15.201 5.99999C12.757 5.99999 11.079 7.49199 11.079 10.231V12.586H8.33197V15.795H11.085V23.997H14.397Z" fill="#2E2E2E"/>
                                                    </g>
                                                    <defs>
